...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_Calculator = QtWidgets.QPushButton(self.widget)
        self.pushButton_Calculator.setObjectName("pushButton_Calculator")
        self.gridLayout_2.addWidget(self.pushButton_Calculator, 3, 1, 1, 1)
        self.pushButton_ApplyOffset = QtWidgets.QPushButton(self.widget)
        self.pushButton_ApplyOffset.setObjectName("pushButton_ApplyOffset")
        self.gridLayout_2.addWidget(self.pushButton_ApplyOffset, 4, 0, 1, 1)
        self.lineEdit_Offset = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_Offset.setObjectName("lineEdit_Offset")
        self.gridLayout_2.addWidget(self.lineEdit_Offset, 4, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_Calculator.setToolTip(_translate("MainWindow", "Refresh the address table[R]"))
        self.pushButton_Calculator.setText(_translate("MainWindow", "Calculator"))
        self.pushButton_ApplyOffset.setToolTip(_translate("MainWindow", "Refresh the address table[R]"))
        self.pushButton_ApplyOffset.setText(_translate("MainWindow", "Apply Offset"))
